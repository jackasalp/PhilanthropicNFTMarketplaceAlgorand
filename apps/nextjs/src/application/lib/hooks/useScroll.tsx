...
import { useEventListener, RefElement } from './useScroll/useEventListener';
...
function useScrollHook(element: RefElement, threshold?: number | string) {
  ...
  const handleScroll = (e: any) => {
    const percentageValue = isValidPercentage
    ...
    setScroll({
      ...
      ...(e.target.scrollTop === 0
        ...
        : {
            ...
            ...(threshold
              ? {
                  hitThreshold: e.target.scrollTop + e.target.clientHeight >= thresholdScale,
                }
              : {}),
          }),
    });
